  ...
  switch (type) {
    case 'filter': return <svg style={style} onClick={onClick} xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36"><title>ic_arrow_drop_up_36px</title>
        <g className="nc-icon-wrapper" fill="#111111">
          ...
          <circle cx="13" cy="13" r="2" stroke-width="2" stroke="#111111" fill="white" />
          <circle cx="24" cy="19" r="2" stroke-width="2" stroke="#111111" fill="white" />
          <circle cx="16" cy="25" r="2" stroke-width="2" stroke="#111111" fill="white" />
        </g>
      </svg>
